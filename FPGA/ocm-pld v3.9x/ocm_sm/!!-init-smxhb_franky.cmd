@echo off
rem --- '!!-init-smxhb_franky.cmd' v2.7 by Ducasp (2022.04.10)
rem based on '!!-init-smx.cmd' v2.7 by KdL (2021.08.23)

set TIMEOUT=1
set FOLDER=init_
set DEVICE=smxhb_franky
if "%1"=="" color 71&title INIT for SMX-HB w/ Franky
...
echo.&echo SMX-HB w/ Franky is ready to compile!
goto timer
